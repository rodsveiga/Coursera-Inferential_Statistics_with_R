...
Here are my answers to the Week 2 Lab Activity of the couse __Inferential Statistics with R__ presented by Coursera and conducted by Mine Çetinkaya-Rundel.

## R Markdown

This is a R Markdown file. To a better viewing, it could be forked and knitted on [RStudio](https://www.rstudio.com/) to a html file or it could be viewed directly as a [RPubs publication](http://rpubs.com/rodsveiga/252173). 
...
The last one is not a condition needed, because the sample size, 60 is, usually, sufficiently large to deal with a skewed sample distribution.
</ol>
...
The "95% confidence" means that 95% of random samples of size 60 will yield confidence intervals that contain the true average area of houses in Ames, Iowa
</ol>
...
Yes, the confidence interval captures the true average size of houses in Ames.
...
<li> 95% </li>
<li> 99% </li>
We expect that 95% of "95% confidence intervals" would capture the true population mean.
</ol>
...
Grafically, we can see that 48/50 = 0.96 of the confidence intervals include the true population mean. This number is correct, since 47/50 = 0.94 and any word about half of interval is meaningless.
...
A 99% confidence level refers to the middle 99% of the distribution, and the critical value associated with this area will correspond to the 99.5th percentile.

The appropriated critical value for a 99% confidence level is 2.58.
...
Grafically, all the 50 intervals include the true population mean. That was expected since 49/50 = 0.98 and we have chosen a 99% confidence interval.
...
Yes, we would expect 99% of the intervals to contain the true population mean.
